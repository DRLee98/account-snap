...
React Native 메인 앱 화면 및 기본 구조.

| ID | 항목 | 상세문서 | 참조문서 | 상태 | 검증 |
|----|------|----------|----------|------|------|
| APP-001 | RN 프로젝트 초기 세팅 (iOS+Android, 네비게이션, 권한) | [docs/APP-001-rn-setup.md](../docs/APP-001-rn-setup.md) | - | ✅ | ✅ |
| APP-002 | 촬영 화면 (카메라) | [docs/APP-002-camera-screen.md](../docs/APP-002-camera-screen.md) | - | ✅ | ✅ |
