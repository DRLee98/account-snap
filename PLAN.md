...
|--------|------|-----------|---------|------|--------|
| OCR 처리 | OCR | [plans/ocr.md](plans/ocr.md) | 2 | 0 | 2 |
| 앱 화면 | APP | [plans/app.md](plans/app.md) | 5 | 0 | 5 |
| 위젯 | WGT | [plans/widget.md](plans/widget.md) | 5 | 1 | 4 |
| 데이터/저장 | DAT | [plans/data.md](plans/data.md) | 3 | 0 | 3 |
| **합계** | - | - | **15** | **1** | **14** |
